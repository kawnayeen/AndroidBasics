...
public final class QueryUtils {
    ...
    public static ArrayList<EarthQuakeInfo> extractEarthquakes(String jsonResponse) {
        ...
        try {
            ...
            for (int i = 0; i < earthQuakeArray.length(); i++) {
                ...
                EarthQuakeInfo quakeInfo = new EarthQuakeInfo(magnitude, location, time, detailsUrl);
    ...
    public static List<EarthQuakeInfo> fetchEarthquakeData(String requestUrl) {
        ...
        try {
            ...
            Log.e("kamarul", "Problem making the HTTP request.", e);
        }

        // Extract relevant fields from the JSON response and create a list of {@link Earthquake}s
        List<EarthQuakeInfo> earthquakes = extractEarthquakes(jsonResponse);
    ...
    private static URL createUrl(String stringUrl) {
        ...
        try {
            ...
            Log.e("kamarul", "Problem building the URL ", e);
        }
        return url;
    }
    ...
    private static String makeHttpRequest(URL url) throws IOException {
        ...
        try {
            ...
            if (urlConnection.getResponseCode() == 200) {
                ...
                Log.e("kamarul", "Error response code: " + urlConnection.getResponseCode());
            }
        } catch (IOException e) {
            Log.e("kamarul", "Problem retrieving the earthquake JSON results.", e);
        } finally {
